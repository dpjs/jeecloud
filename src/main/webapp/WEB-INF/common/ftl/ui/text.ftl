...
-->
<#macro text
	maxlength="" readonly="" value="" placeholder="" onafterpaste="" autocomplete="off"
	label="" noHeight="false" required="" colspan="" width="100" help="" helpPosition="2" colon=":" hasColon="true"
